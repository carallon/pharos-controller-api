...
project = u'Controller API Documentation'
...
htmlhelp_basename = 'ControllerApiDocumentation'
...
latex_documents = [
    (master_doc, 'ControllerApiDocumentation.tex', u'Controller API Documentation',
...
man_pages = [
    (master_doc, 'controllerapidocumentation', u'Controller API Documentation',
     [u'Carallon Ltd'], 1)
]
...
texinfo_documents = [
    (master_doc, 'ControllerApiDocumentation', u'Controller API Documentation',
     u'Carallon Ltd', 'ControllerApiDocumentation',
     'User documentation of HTTP, Javascript and Lua API.',
     'Miscellaneous'),
]
